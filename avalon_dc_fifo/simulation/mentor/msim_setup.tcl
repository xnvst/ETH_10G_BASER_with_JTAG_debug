...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "avalon_dc_fifo"
}
...
alias com {
  ...
  vlog "$QSYS_SIMDIR/submodules/altera_avalon_dc_fifo.v"             -work dc_fifo       
  vlog "$QSYS_SIMDIR/submodules/altera_dcfifo_synchronizer_bundle.v" -work dc_fifo       
  vlog "$QSYS_SIMDIR/avalon_dc_fifo.v"                                                   
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS -L work -L work_lib -L rst_controller -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rst_controller -L dc_fifo -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver $TOP_LEVEL_NAME
}
