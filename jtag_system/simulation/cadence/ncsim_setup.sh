...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_rsp_mux.sv"    -work rsp_mux                          -cdslib ./cds_libs/rsp_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_rsp_demux.sv"  -work rsp_demux                        -cdslib ./cds_libs/rsp_demux.cds.lib                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work cmd_mux                          -cdslib ./cds_libs/cmd_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_cmd_mux.sv"    -work cmd_mux                          -cdslib ./cds_libs/cmd_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_cmd_demux.sv"  -work cmd_demux                        -cdslib ./cds_libs/cmd_demux.cds.lib                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"            -work mm_bridge_master_m0_limiter      -cdslib ./cds_libs/mm_bridge_master_m0_limiter.cds.lib     
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"             -work mm_bridge_master_m0_limiter      -cdslib ./cds_libs/mm_bridge_master_m0_limiter.cds.lib     
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                     -work mm_bridge_master_m0_limiter      -cdslib ./cds_libs/mm_bridge_master_m0_limiter.cds.lib     
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"            -work mm_bridge_master_m0_limiter      -cdslib ./cds_libs/mm_bridge_master_m0_limiter.cds.lib     
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_router_001.sv" -work router_001                       -cdslib ./cds_libs/router_001.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_router.sv"     -work router                           -cdslib ./cds_libs/router.cds.lib                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work rsp_mux                          -cdslib ./cds_libs/rsp_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_rsp_mux.sv"    -work rsp_mux                          -cdslib ./cds_libs/rsp_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work cmd_mux                          -cdslib ./cds_libs/cmd_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_cmd_mux.sv"    -work cmd_mux                          -cdslib ./cds_libs/cmd_mux.cds.lib                         
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_cmd_demux.sv"  -work cmd_demux                        -cdslib ./cds_libs/cmd_demux.cds.lib                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_router_001.sv" -work router_001                       -cdslib ./cds_libs/router_001.cds.lib                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_router.sv"     -work router                           -cdslib ./cds_libs/router.cds.lib                          
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                -work mm_bridge_master_s0_agent        -cdslib ./cds_libs/mm_bridge_master_s0_agent.cds.lib       
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"         -work mm_bridge_master_s0_agent        -cdslib ./cds_libs/mm_bridge_master_s0_agent.cds.lib       
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"               -work jtag_master_master_agent         -cdslib ./cds_libs/jtag_master_master_agent.cds.lib        
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"           -work mm_bridge_master_s0_translator   -cdslib ./cds_libs/mm_bridge_master_s0_translator.cds.lib  
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"          -work jtag_master_master_translator    -cdslib ./cds_libs/jtag_master_master_translator.cds.lib   
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_p2b_adapter.sv"      -work p2b_adapter                      -cdslib ./cds_libs/p2b_adapter.cds.lib                     
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_b2p_adapter.sv"      -work b2p_adapter                      -cdslib ./cds_libs/b2p_adapter.cds.lib                     
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_timing_adt.sv"       -work timing_adt                       -cdslib ./cds_libs/timing_adt.cds.lib                      
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1.v"             -work mm_interconnect_1                -cdslib ./cds_libs/mm_interconnect_1.cds.lib               
  ncvlog     "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0.v"             -work mm_interconnect_0                -cdslib ./cds_libs/mm_interconnect_0.cds.lib               
  ncvlog     "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"                   -work mm_bridge_master                 -cdslib ./cds_libs/mm_bridge_master.cds.lib                
  ncvlog     "$QSYS_SIMDIR/submodules/jtag_system_jtag_master.v"                   -work jtag_master                      -cdslib ./cds_libs/jtag_master.cds.lib                     
  ncvlog     "$QSYS_SIMDIR/jtag_system.v"                                                                                                                                            
fi
