...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_rsp_mux.sv"    -work rsp_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_rsp_demux.sv"  -work rsp_demux                       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work cmd_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_cmd_mux.sv"    -work cmd_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_cmd_demux.sv"  -work cmd_demux                       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"            -work mm_bridge_master_m0_limiter     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"             -work mm_bridge_master_m0_limiter     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                     -work mm_bridge_master_m0_limiter     
  vlog -sv "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"            -work mm_bridge_master_m0_limiter     
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_router_001.sv" -work router_001                      
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_1_router.sv"     -work router                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work rsp_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_rsp_mux.sv"    -work rsp_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                 -work cmd_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_cmd_mux.sv"    -work cmd_mux                         
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_cmd_demux.sv"  -work cmd_demux                       
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_router_001.sv" -work router_001                      
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_mm_interconnect_0_router.sv"     -work router                          
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                -work mm_bridge_master_s0_agent       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"         -work mm_bridge_master_s0_agent       
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"               -work jtag_master_master_agent        
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"           -work mm_bridge_master_s0_translator  
  vlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"          -work jtag_master_master_translator   
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_p2b_adapter.sv"      -work p2b_adapter                     
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_b2p_adapter.sv"      -work b2p_adapter                     
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/jtag_system_jtag_master_timing_adt.sv"       -work timing_adt                      
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS -L work -L work_lib -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L mm_bridge_master_m0_limiter -L router_001 -L router -L mm_bridge_master_s0_agent -L jtag_master_master_agent -L mm_bridge_master_s0_translator -L jtag_master_master_translator -L p2b_adapter -L b2p_adapter -L transacto -L p2b -L b2p -L fifo -L timing_adt -L jtag_phy_embedded_in_jtag_master -L rst_controller -L mm_interconnect_1 -L mm_interconnect_0 -L mm_bridge_master -L jtag_master -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver $TOP_LEVEL_NAME
}
