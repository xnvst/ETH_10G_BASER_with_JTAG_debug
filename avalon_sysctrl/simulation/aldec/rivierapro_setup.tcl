...
# ACDS 14.0 205 win32 2014.11.09.00:47:11
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "avalon_sysctrl"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/avalon_sysctrl_onchip_memory2_0.hex ./
}
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work mm_bridge_m0_translator       
  ...
  vlog  "$QSYS_SIMDIR/submodules/avalon_sysctrl_mm_interconnect_0.v" -work mm_interconnect_0             
  vlog  "$QSYS_SIMDIR/submodules/avalon_sysctrl_onchip_memory2_0.v"  -work onchip_memory2_0              
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"          -work mm_bridge                     
  vlog  "$QSYS_SIMDIR/avalon_sysctrl.v"                                                                  
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L onchip_memory2_0_s1_translator -L mm_bridge_m0_translator -L rst_controller -L mm_interconnect_0 -L onchip_memory2_0 -L mm_bridge -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L onchip_memory2_0_s1_translator -L mm_bridge_m0_translator -L rst_controller -L mm_interconnect_0 -L onchip_memory2_0 -L mm_bridge -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L arriav_ver -L arriav_hssi_ver -L arriav_pcie_hip_ver $TOP_LEVEL_NAME
}
