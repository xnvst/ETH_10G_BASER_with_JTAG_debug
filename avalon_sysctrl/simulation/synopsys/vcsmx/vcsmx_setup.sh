...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/avalon_sysctrl_onchip_memory2_0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv" -work mm_bridge_m0_translator       
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/avalon_sysctrl_mm_interconnect_0.v" -work mm_interconnect_0             
  vlogan +v2k           "$QSYS_SIMDIR/submodules/avalon_sysctrl_onchip_memory2_0.v"  -work onchip_memory2_0              
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"          -work mm_bridge                     
  vlogan +v2k           "$QSYS_SIMDIR/avalon_sysctrl.v"                                                                  
fi
