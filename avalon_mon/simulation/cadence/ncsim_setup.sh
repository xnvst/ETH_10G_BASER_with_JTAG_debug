...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog     "$QSYS_SIMDIR/submodules/avalon_mon_mm_interconnect_0.v"     -work mm_interconnect_0              -cdslib ./cds_libs/mm_interconnect_0.cds.lib             
  ncvlog     "$QSYS_SIMDIR/submodules/avalon_mon_onchip_memory2_0.v"      -work onchip_memory2_0               -cdslib ./cds_libs/onchip_memory2_0.cds.lib              
  ncvlog     "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"          -work mm_bridge                      -cdslib ./cds_libs/mm_bridge.cds.lib                     
  ncvlog     "$QSYS_SIMDIR/avalon_mon.v"                                                                                                                                
fi
