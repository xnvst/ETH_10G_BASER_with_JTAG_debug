...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/avalon_mon_onchip_memory2_0.hex ./
}
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/avalon_mon_mm_interconnect_0.v"     -work mm_interconnect_0             
  vlog  "$QSYS_SIMDIR/submodules/avalon_mon_onchip_memory2_0.v"      -work onchip_memory2_0              
  vlog  "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"          -work mm_bridge                     
  vlog  "$QSYS_SIMDIR/avalon_mon.v"                                                                      
}
