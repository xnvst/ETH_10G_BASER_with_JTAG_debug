...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/avalon_mon_mm_interconnect_0.v"     -work mm_interconnect_0             
  vlogan +v2k           "$QSYS_SIMDIR/submodules/avalon_mon_onchip_memory2_0.v"      -work onchip_memory2_0              
  vlogan +v2k           "$QSYS_SIMDIR/submodules/altera_avalon_mm_bridge.v"          -work mm_bridge                     
  vlogan +v2k           "$QSYS_SIMDIR/avalon_mon.v"                                                                      
fi
